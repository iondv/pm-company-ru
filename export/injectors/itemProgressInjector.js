  ...
  this.inject = function (value) {
    if (value) {
      if (value.__class && 
        ...
        if(value.__class === 'program@pm-company-ru' && value.project) {
