...
function changeReqInjector() {
  ...
  this.inject = function (value) {
    if (value) {
      if (value.__class && value.__class === 'changeReq@pm-company-ru') {
        ...
        if  (_changeIndicatorsColl && _changeIndicatorsColl.length) {
          for (let i = 0; i < _changeIndicatorsColl.length; i++) {
            if (_changeIndicatorsColl[i] && 
              ...
              (_changeIndicatorsColl[i].currentEdition.__class === 'indicatorFinancial@pm-company-ru' ||
              _changeIndicatorsColl[i].currentEdition.__class === 'indicatorDigital@pm-company-ru')) {
            ...
            if (_changeIndicatorsColl[i] && 
              ...
              (_changeIndicatorsColl[i].newEdition.__class === 'indicatorFinancial@pm-company-ru' ||
              _changeIndicatorsColl[i].newEdition.__class === 'indicatorDigital@pm-company-ru')) {
        ...
        if  (_changeIndicatorsColl && _changeIndicatorsColl.length) {
          for (let i = 0; i < _changeIndicatorsColl.length; i++) {
            ...
            if (_changeIndicatorsColl[i] && 
              _changeIndicatorsColl[i].currentEdition && 
              _changeIndicatorsColl[i].currentEdition.__class && 
              _changeIndicatorsColl[i].currentEdition.__class === 'indicatorBudget@pm-company-ru') {
            ...
            if (_changeIndicatorsColl[i] && 
              _changeIndicatorsColl[i].newEdition && 
              _changeIndicatorsColl[i].newEdition.__class && 
              _changeIndicatorsColl[i].newEdition.__class === 'indicatorBudget@pm-company-ru') {
