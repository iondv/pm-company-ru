...
module.exports = function (options) {
  function createIndicatorValue(cn, start, period, logger, item, user, /*offset,*/ end) {
    ...
    return () => options.data
      ...
      .then(iv => options.workflows.pushToState(iv, 'indicatorValueBasic@pm-company-ru', stateValue, {user: user}))
  ...
  return function (item, user, logger) {
    ...
    switch (typeValue) {
      case 'indicatorDigital@pm-company-ru':
        cn = 'indicatorValueDigital@pm-company-ru';
        break;
      case 'indicatorFinancial@pm-company-ru':
        cn = 'indicatorValueFinancial@pm-company-ru';
        break;
      case 'indicatorMedia@pm-company-ru':
        cn = 'indicatorValueMedia@pm-company-ru';
        break;
      case 'indicatorText@pm-company-ru':
        cn = 'indicatorValueText@pm-company-ru';
        break;
      case 'indicatorBudget@pm-company-ru':
        cn = 'indicatorValueBudget@pm-company-ru';
        break;
      case 'indicatorLimBudget@pm-company-ru':
        cn = 'indicatorValueLimBudget@pm-company-ru';
        break;
      default:
    ...
    let since;
    let till;
    if (item.getClassName() === 'indicatorBudget@pm-company-ru') {
