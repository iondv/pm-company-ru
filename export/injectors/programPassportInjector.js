...
function programPassportInjector() {
  ...
  this.inject = function (value) {
    if (value) {
      if (value.__class && value.__class === 'program@pm-company-ru') {
...
///
            ...
            if (_problemRegColl && _problemRegColl.length) {
              for (let b = 0; b < _problemRegColl.length; b++) {
                ...
                if  (_indicatorBasicColl && _indicatorBasicColl.length) {
                  for (let i = 0; i < _indicatorBasicColl.length; i++) {
                    if (_indicatorBasicColl[i].__class === 'indicatorMedia@pm-company-ru') {
                    ...
                    if (_indicatorBasicColl[i].__class === 'indicatorText@pm-company-ru') {
                      let _sumAllPlan = '';
                      let _sumAllFact = '';
                      let _sumTrueEndProgress = 0;
                      let _sumAllEndProgress = 0;
                    ...
                    if (_indicatorBasicColl[i].__class === 'indicatorFinancial@pm-company-ru' || _indicatorBasicColl[i].__class === 'indicatorDigital@pm-company-ru') {
                      let _sumAllPlan = 0;
                      let _sumAllFact = 0;
                      let _sumAllProg = 0;
                      let _sumTrueEndProgress = 0;
