...
(function () {
  ...
  var places = {
    sakh: {
      objectMenuUrl: 'registry/api/eventObject@pm-company-ru',
      objectUrl: 'registry/api/eventObject@pm-company-ru/',
      objectData: {},
      reportObjUrl: 'report/pm-company-ru@eventsBase/cardObject/cardObject/data',
      reportFinUrl: 'report/pm-company-ru@eventsBase/cardFin/cardFin/data',
      reportWorkUrl: 'report/pm-company-ru@eventsBase/cardWork/cardWork/data'
    }
  };
  ...
  function loadExtraObjectData (data, cb) {
    ...
    if (data.objectBasic) {
      requests.push(function (cb) {
        getAjax('registry/api/objectBasic@pm-company-ru/' + data.objectBasic).done(function (res) {
    ...
    if (data.head) {
      requests.push(function (cb) {
        getAjax('registry/api/employee@pm-company-ru/' + data.head).done(function (result) {
          data.head = result;
        }).always(function () {cb();});
      });
    }
